...
public class InvoicingTest {
        ...
        void testInvoicingFlow() throws Exception {
                ...
                String itemUuid = (String) objectMapper
                                .readValue(itemResult.getResponse().getContentAsString(), Map.class).get("uuid");

                // 2. Create Invoice with Line referencing Item
                // Note: GenericRestController expects "itemId": "uuid" in the map for
                // relationships
                ...
                String invoiceUuid = (String) objectMapper
                                .readValue(invoiceResult.getResponse().getContentAsString(), Map.class).get("uuid");
